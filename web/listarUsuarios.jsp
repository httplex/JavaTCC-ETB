...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="conteudo">
                <div class="col-12">
                    <h3 class="text-center mt-5 text-primary text" style="padding-top: 90px">Listagem de Usuários</h3>
                                          ...
                                          <c:choose>
                                              <c:when test="${p.status == 1}">
                                                  <button class="btn btn-danger btn-sm"
                                                          onclick="confirmDesativar('${p.idUsuario}', '${p.nome}')">
                                                      Desativar&nbsp;
                                              ...
                                              <c:otherwise>
                                                  <button class="btn btn-success btn-sm"
                                                          onclick="confirmAtivar('${p.idUsuario}', '${p.nome}')">
                                                      Ativar&nbsp;
